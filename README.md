...
According to the NASA Exoplanet Archive and other catalogs, the main criteria are:
    ...
    Mass Limit:
        ...
        Must be ≤ 30 Jupiter masses.

        Anything larger is considered a brown dwarf (a “failed star”).
